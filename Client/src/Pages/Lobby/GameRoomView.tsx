...
// import type { GameRoom, GameMap, GameTile, MapSize } from '@shared/types/types';
// import { sessionManager } from '@/singleton/sessionManager';
// import { lobbySocket } from '@/Request-Respond/ws/lobbySocket';
...
//   useEffect(() => {
//     // TODO: This component needs to be updated for the waiting room service
//     // For now, we'll disable the WebSocket handlers since they don't match the new lobby service
//     console.log('GameRoomView loaded for room:', currentRoom.id);
    
//     // The GameRoomView should connect to the waiting room service, not the lobby service
//     // This will be implemented when the waiting room service is created
